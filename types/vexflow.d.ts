export declare namespace Vex {
  ...
  namespace Flow {
    ...
    function tabToGlyph(
      fret: string
    ): { text: string; code: number; width: number; shift_y: number };
    ...
    function parseNoteDurationString(
      durationString: string
    ): { duration: string; dots: number; type: string };
    ...
    class Bend extends Modifier {
      constructor(
        text: string,
        release?: boolean,
        phrase?: { type: number; text: string; width: number }[]
      );
    ...
    class Glyph {
      constructor(
        code: string,
        point: number,
        options?: { cache?: boolean; font?: IFont }
      );
    ...
    class KeyManager {
      ...
      selectNote(
        note: string
      ): { note: string; accidental: string; change: boolean };
    }
    ...
    class Music {
      ...
      getKeyParts(
        noteString: string
      ): { root: string; accidental: string; type: string };
    ...
    namespace Music {
      ...
      const diatonic_accidentals: {
        [diatonic_interval: string]: { note: number; accidental: number };
      };
    ...
    namespace PedalMarking {
      ...
      const GLYPHS: {
        [name: string]: { code: string; x_shift: number; y_shift: number };
      };
    }
    ...
    class Stave {
      ...
      setContext(context: IRenderContext): Vex.Flow.Stave;
      ...
      setClef(type: string): void;

      setTimeSignature(type: string): void;
      ...
      setContext(type: SVGContext): void;
      ...
      setTempo(
        tempo: { name?: string; duration: string; dots: boolean; bpm: number },
        y: number
      ): Stave;
    ...
    class StaveConnector {
      ...
      setText(
        text: string,
        text_options?: { shift_x?: number; shift_y?: number }
      ): StaveConnector;
